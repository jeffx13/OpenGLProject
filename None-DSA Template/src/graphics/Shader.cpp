...
Shader::Shader(const std::string& VertexShaderPath, const std::string& FragmentShaderPath)
{
    ...
    std::string vs_source = ParseFile(VertexShaderPath);
    std::string fs_source = ParseFile(FragmentShaderPath);
    m_RendererID = CreateShader(vs_source, fs_source);
}
...
void Shader::Set4f(const std::string& name, glm::vec4 v)
{
...
void Shader::Set3f(const std::string& name, glm::vec3 v)
{
    GLCall(Set3f(name, v.x, v.y, v.z));
}
